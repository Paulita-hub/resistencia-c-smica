...
class Palette {
  Color get pen => const Color(0xff4cc9f0);
  Color get darkPen => const Color(0xFF4361EE);
  Color get redPen => const Color(0xFFf72585);
  Color get inkFullOpacity => const Color(0xffe8ecff);
  Color get ink => const Color(0xeee8ecff);
  Color get backgroundMain => const Color(0xff070b1a);
  Color get backgroundLevelSelection => const Color(0xff12183a);
  Color get backgroundPlaySession => const Color(0xff070b1a);
  Color get background4 => const Color(0xff1a1f3d);
  Color get backgroundSettings => const Color(0xff1a1f3d);
